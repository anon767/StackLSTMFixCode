gint16
CVE_2013_1573_PATCHED_csnStreamDissector(proto_tree *tree, csnStream_t* ar, const CSN_DESCR* pDescr, tvbuff_t *tvb, void* data, int ett_csn1)
{
  ...
  do
  {
    switch (pDescr->type)
    {
      case CSN_BIT:
      {
        ...
        {
          return ProcessError(tree, tvb, bit_offset,"CVE_2013_1573_PATCHED_csnStreamDissector", CSN_ERROR_NEED_MORE_BITS_TO_UNPACK, pDescr);
        }
      ...
      case CSN_UINT:
      {
        ...
        if (remaining_bits_len >= no_of_bits)
        {
          ...
          {
            return ProcessError(tree, tvb, bit_offset,"CVE_2013_1573_PATCHED_csnStreamDissector", CSN_ERROR_GENERAL, pDescr);
          }
      ...
      case CSN_UINT_ARRAY:
      {
        ...
        if (remaining_bits_len >= no_of_bits)
        {
          ...
          {
            return ProcessError(tree, tvb, bit_offset,"CVE_2013_1573_PATCHED_csnStreamDissector NOTIMPLEMENTED", 999, pDescr);
          }
          else if (no_of_bits <= 32)
          {
            return ProcessError(tree, tvb, bit_offset,"CVE_2013_1573_PATCHED_csnStreamDissector NOTIMPLEMENTED", 999, pDescr);
      ...
      case CSN_TYPE_ARRAY:
      {
        ...
        { /* resulting array of length 0 is possible
          ...
          Status = CVE_2013_1573_PATCHED_csnStreamDissector(test_tree, &arT, pDescr->descr.ptr, tvb, pui8, ett_csn1);
          if (Status >= 0)
          {
            pui8    += nSize;
      ...
      { /* bitmap with given length. The result is left aligned! */
        ...
        if (no_of_bits > 0)
        {
          ...
          {
            return ProcessError(tree, tvb, bit_offset,"CVE_2013_1573_PATCHED_csnStreamDissector NOT IMPLEMENTED", 999, pDescr);
          }
      ...
      case CSN_TYPE:
      {
        ...
        csnStreamInit(&arT, bit_offset, remaining_bits_len);
        Status = CVE_2013_1573_PATCHED_csnStreamDissector(test_tree, &arT, pDescr->descr.ptr, tvb, pvDATA(data, pDescr->offset), ett_csn1);
        ...
        {
          /* Has already been processed: ProcessError("CVE_2013_1573_PATCHED_csnStreamDissector", Status, pDescr);  */
          return Status;
        }
        ...
        while (count > 0)
        {
          ...
          if (value == pChoice->value)
          {
            ...
            *pui8         = i;
            ...
            csnStreamInit(&arT, bit_offset, remaining_bits_len);
            Status = CVE_2013_1573_PATCHED_csnStreamDissector(test_tree, &arT, descr, tvb, data, ett_csn1);
      ...
      case CSN_UNION:
      {
        ...
        if ((count <= 0) || (count > 16))
        {
          return ProcessError(tree, tvb, bit_offset,"CVE_2013_1573_PATCHED_csnStreamDissector", CSN_ERROR_INVALID_UNION_INDEX, pDescr);
        }
        ...
        *pui8 = index;
        ...
        { /* get the right element of the union based on computed index */
          ...
          { /* descriptions of union elements other than above are illegal */
            return ProcessError(tree, tvb, bit_offset,"CVE_2013_1573_PATCHED_csnStreamDissector", CSN_ERROR_IN_SCRIPT, pDescr);
          }
        }
      ...
      { /* Verify the fixed bits */
        ...
        {
          return ProcessError(tree, tvb, bit_offset,"CVE_2013_1573_PATCHED_csnStreamDissector FIXED value does not match", -1, pDescr);
        }
        proto_tree_add_text(tree, tvb, bit_offset>>3, ((bit_offset+no_of_bits-1)>>3)-(bit_offset>>3)+1, "%s %s",
                                   decode_bits_in_field(bit_offset, no_of_bits, tvb_get_bits8(tvb, bit_offset, no_of_bits)),
                                   pDescr->sz);
      ...
      case CSN_TRAP_ERROR:
      {
        return ProcessError(tree, tvb, bit_offset,"CVE_2013_1573_PATCHED_csnStreamDissector", pDescr->i, pDescr);
      }
