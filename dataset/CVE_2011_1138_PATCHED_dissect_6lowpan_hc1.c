static tvbuff_t *
CVE_2011_1138_PATCHED_dissect_6lowpan_hc1(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, gint dgram_size, proto_item *length_item)
{
    gint                offset = 0;
    gint                bit_offset;
    int                 i;
    ...
    return ipv6_tvb;
} /* CVE_2011_1138_PATCHED_dissect_6lowpan_hc1 */
