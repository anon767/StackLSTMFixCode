 *
 * CVE_2014_3523_PATCHED_winnt_accept()
...
static unsigned int __stdcall CVE_2014_3523_PATCHED_winnt_accept(void *lr_)
{
    ...
    if (!accf_name) {
        ...
        ap_log_error(APLOG_MARK, APLOG_WARNING, 0, ap_server_conf,
                     APLOGNO(02531) "CVE_2014_3523_PATCHED_winnt_accept: Listen protocol '%s' has "
        ...
        ap_log_error(APLOG_MARK, APLOG_WARNING, 0, ap_server_conf, APLOGNO(00331)
                     "CVE_2014_3523_PATCHED_winnt_accept: unrecognized AcceptFilter '%s', "
    ...
    if (getsockname(nlsd, (struct sockaddr *)&ss_listen, &namelen) == SOCKET_ERROR) {
        ap_log_error(APLOG_MARK, APLOG_ERR, apr_get_netos_error(),
                     ...
                     "CVE_2014_3523_PATCHED_winnt_accept: getsockname error on listening socket, "
                     "is IPv6 available?");
        return 1;
   }
#endif
    ...
    if (accf > 0) /* 'data' or 'connect' */
    {
        if (WSAIoctl(nlsd, SIO_GET_EXTENSION_FUNCTION_POINTER,
            ...
            ap_log_error(APLOG_MARK, APLOG_ERR, apr_get_netos_error(),
                         ...
                         "CVE_2014_3523_PATCHED_winnt_accept: failed to retrieve AcceptEx, try 'AcceptFilter none'");
            return 1;
        }
        if (WSAIoctl(nlsd, SIO_GET_EXTENSION_FUNCTION_POINTER,
            ...
            ap_log_error(APLOG_MARK, APLOG_ERR, apr_get_netos_error(),
                         ...
                         "CVE_2014_3523_PATCHED_winnt_accept: failed to retrieve GetAcceptExSockaddrs, try 'AcceptFilter none'");
            return 1;
        }
                ...
                if (!timeout) {
                    ...
                    if (err_count > MAX_ACCEPTEX_ERR_COUNT) {
                        ap_log_error(APLOG_MARK, APLOG_CRIT, 0, ap_server_conf, APLOGNO(00335)
                                     "CVE_2014_3523_PATCHED_winnt_accept: Too many failures grabbing a "
        ...
        if (accf > 0) /* Either 'connect' or 'data' */
        {
            ...
            if (context->accept_socket == INVALID_SOCKET) {
                ap_log_error(APLOG_MARK, APLOG_WARNING, apr_get_netos_error(),
                             ...
                             "CVE_2014_3523_PATCHED_winnt_accept: Failed to allocate an accept socket. "
                ...
                if (rv == WAIT_OBJECT_0) {
                    if ((context->accept_socket != INVALID_SOCKET) &&
                        ...
                        ap_log_error(APLOG_MARK, APLOG_WARNING,
                             ...
                             "CVE_2014_3523_PATCHED_winnt_accept: Asynchronous AcceptEx failed.");
                        closesocket(context->accept_socket);
                        context->accept_socket = INVALID_SOCKET;
                    }
                }
