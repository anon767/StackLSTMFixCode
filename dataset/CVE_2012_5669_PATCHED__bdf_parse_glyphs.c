                     ...
                     void*          client_data )
  {
    ...
    if ( !( p->flags & _BDF_GLYPHS ) )
    {
      ...
      {
        FT_ERROR(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ERRMSG1, lineno, "CHARS" ));
      ...
      if ( p->cnt >= 0x110000UL )
      {
        FT_ERROR(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ERRMSG5, lineno, "CHARS" ));
    ...
    if ( ft_memcmp( line, "STARTCHAR", 9 ) == 0 )
    {
      ...
      if ( !s )
      {
        FT_ERROR(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ERRMSG8, lineno, "STARTCHAR" ));
    ...
    if ( ft_memcmp( line, "ENCODING", 8 ) == 0 )
    {
      if ( !( p->flags & _BDF_GLYPH ) )
      {
        ...
        FT_ERROR(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ERRMSG1, lineno, "STARTCHAR" ));
      ...
      {
        FT_ERROR(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ERRMSG5, lineno, "ENCODING" ));
        error = BDF_Err_Invalid_File_Format;
        goto Exit;
      }
      ...
      if ( p->glyph_enc >= 0 )
      {
        if ( _bdf_glyph_modified( p->have, p->glyph_enc ) )
        {
          ...
          /* unencoded area.                                     */
          FT_TRACE2(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ACMSG12,
    ...
    if ( p->flags & _BDF_BITMAP )
    {
      ...
      if ( p->row >= (unsigned long)glyph->bbx.height )
      {
        ...
        {
          FT_TRACE2(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ACMSG13, glyph->encoding ));
      ...
      {
        FT_TRACE2(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ACMSG16, glyph->encoding ));
        p->flags       |= _BDF_GLYPH_WIDTH_CHECK;
        font->modified  = 1;
      }
      ...
      if ( i == nibbles                           &&
           ...
           !( p->flags & _BDF_GLYPH_WIDTH_CHECK ) )
      {
        FT_TRACE2(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ACMSG14, glyph->encoding ));
        p->flags       |= _BDF_GLYPH_WIDTH_CHECK;
        font->modified  = 1;
      }
    ...
    if ( ft_memcmp( line, "DWIDTH", 6 ) == 0 )
    {
      ...
      if ( !( p->flags & _BDF_SWIDTH ) )
      {
        ...
        FT_TRACE2(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ACMSG9, lineno ));
    ...
    if ( ft_memcmp( line, "BBX", 3 ) == 0 )
    {
      ...
      if ( !( p->flags & _BDF_DWIDTH ) )
      {
        ...
        FT_TRACE2(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ACMSG10, lineno ));
    ...
    if ( ft_memcmp( line, "BITMAP", 6 ) == 0 )
    {
      ...
      {
        /* Missing BBX field. */
        FT_ERROR(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ERRMSG1, lineno, "BBX" ));
      ...
      {
        FT_ERROR(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ERRMSG4, lineno ));
    ...
    FT_ERROR(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ERRMSG9, lineno ));
    error = BDF_Err_Invalid_File_Format;
    goto Exit;

  Missing_Encoding:
    /* Missing ENCODING field. */
    FT_ERROR(( "CVE_2012_5669_PATCHED__bdf_parse_glyphs: " ERRMSG1, lineno, "ENCODING" ));
